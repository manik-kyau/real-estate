                ...
                <form onSubmit={handleLoginForm} className="space-y-8">
                    <div className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <input type="email" name="email" placeholder="Enter Email Address:" className="w-full px-3 py-2 border rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600" />
                        </div>
                        <div className="space-y-2">
                            ...
                            <input type="password" name="password" placeholder="Enter Password" className="w-full px-3 py-2 border rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600" />
                        </div>
                    </div>
                        <input type="submit" value='Login' className="w-full text-base font-medium px-3 py-2 border rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600 bg-green-500 text-white" />
                </form>
            </div>
        </div>
    );
